// m20241220_000002_create_chef_table.rs

use sea_orm_migration::prelude::*;

use super::m20241220_000001_create_bakery_table::Bakery;

pub struct Migration;

impl MigrationName for Migration {
    fn name(&self) -> &str {
        "m20241220_000002_create_chef_table" // Make sure this matches with the file name
    }
}
